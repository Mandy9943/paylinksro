              ...
              {data?.length === 0 ? (
                <div className="p-8 text-center">
                  ...
                  <p className="text-sm text-slate-500 mb-6">
                    Creează primul tău link de plată pentru a începe să primești
                    plăți.
                  </p>
                  <Button
                    size="lg"
                    className="bg-blue-600 hover:bg-blue-700 text-white shadow-lg hover:shadow-xl transition-all duration-200 px-8 py-3 text-base font-medium rounded-xl"
