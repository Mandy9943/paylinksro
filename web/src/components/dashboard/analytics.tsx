...
import { TrendingUp, Clock, AlertTriangle, UserPlus, CreditCard } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold text-gray-900 mb-2">0,00 RON</div>
            ...
            <div className="mt-4 h-32 bg-gradient-to-r from-blue-600 to-blue-400 rounded-lg flex items-center justify-center">
              <div className="text-white text-sm font-medium">📊 Grafic indisponibil</div>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-sm font-medium text-gray-500">Tranzacții de succes</h3>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-sm font-medium text-gray-500">Timp mediu procesare</h3>
